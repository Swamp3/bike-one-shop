...
Entschieden seit letzter Fassung: Shopsystem **Shopware** *(in der Phase-6-Planung revidiert zu Medusa.js v2 — siehe [decisions.md](../3-Architecture_Tech_Stack/decisions.md))*, Zahlungsdienstleister **SumUp** (siehe [docs/DECISIONS.md](../../docs/DECISIONS.md)); Datenfluss Tridata↔Shop, Auth-Strategie, sonstige Bestandssysteme (WordPress-Seite vorhanden), kein festes Budget-Limit.
...
- Bestätigung: Angular für Frontend, Tailwind fürs Styling — final oder noch offen?
  ...
  **Nachtrag (Phase-6-Planung):** Diese Entscheidung wurde später revidiert — Frontend ist jetzt **Next.js** statt Angular. Details und Begründung siehe [decisions.md](../3-Architecture_Tech_Stack/decisions.md), Abschnitt "Frontend framework".
- Shopsystem?
  → **Shopware**, final entschieden.
  **Nachtrag (Phase-6-Planung):** Diese Entscheidung wurde später revidiert — Shopsystem ist jetzt **Medusa.js v2** statt Shopware. Details und Begründung siehe [decisions.md](../3-Architecture_Tech_Stack/decisions.md), Abschnitt "Shop system".
...
- **Neu erkannt (September 2026):** Ab 27.09.2026 gelten neue EU-Informationspflichten für den Verkauf physischer Waren an Verbraucher — Garantiehinweise und das sogenannte "GARAN"-Label müssen auf Produktdetailseiten angezeigt werden. Shopware unterstützt dies nativ ab Version 6.7.14.0 ohne zusätzliche Erweiterung — **da das Shopsystem inzwischen zu Medusa.js gewechselt wurde (siehe Nachtrag oben), entfällt dieser native Support**; das Label muss als eigene Komponente im Next.js-Frontend gebaut werden (siehe Phase-6-Planung). Sollte im Rahmen der anwaltlichen AGB-Prüfung mit abgedeckt werden, da das Datum sehr kurzfristig ist (in dieser Woche in Kraft, direkt betroffen wäre aber erst der spätere Go-Live).
